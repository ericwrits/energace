...
const CORE_VALUES  = [ 
  {
    title: 'CBT Therapy',
    icon: 'https://cdn-icons-png.flaticon.com/512/1491/1491477.png',
  ...
  },
  {
    ...
    icon: 'https://cdn-icons-png.flaticon.com/512/1491/1491416.png',
  ...
  },
  {
    ...
    icon: 'https://cdn-icons-png.flaticon.com/512/6432/6432826.png',
  ...
  {
    title: 'Group Therapy',
    icon: 'https://cdn-icons-png.flaticon.com/512/7283/7283621.png',
  ...
  },
  {
    ...
    icon: 'https://cdn-icons-png.flaticon.com/512/7248/7248795.png',
    ...
    <RootStyle>
      <Container>
        ...
        {CORE_VALUES.map((services) => (
          <Grid key={services.title} container spacing={3} justifyContent="center" alignItems="center">
